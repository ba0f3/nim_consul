...
proc initConsulParams*(uri = ""): tuple[uri: string] =
  var consulUri = uri
  if consulUri.len == 0:
...
proc kvGet*(consul: AsyncConsul | Consul, key: string, aclToken = ""): Future[KvResponse] {.multisync.} =
